      ...
      <div className={styles.imgSection}>
        ...
        <div className={styles.solSection}>
          <span className={styles.solItem}>
            <Image className={styles.image} src={"/first.png"} width={200} height={120} />
          ...
          <span className={styles.solItem}>
            <Image className={styles.image} src={"/sec.png"} width={200} height={120} />
            <h3>Culture</h3>
            <p>Creating a unified and elastic culture that invites diversity allows for change to be positively accepted.</p>
          </span>
          <span className={styles.solItem}>
            <Image className={styles.image} src={"/third.png"} width={200} height={120} />
          ...
          <span className={styles.solItem}>
            <Image className={styles.image} src={"/fourth.png"} width={200} height={120} />
            <h3>Capabilities</h3>
